...
export default function ProductImageSection({
  ...
  return (
    /**
     * Layout giống ThredUp:
     * - Desktop: 2 cột – rail trái cố định ~120px cho thumbnails, phải fill
     * - Mobile: xếp dọc; dùng gap-y để có khoảng trống dưới main image
     */
    <div
      className={
        className ??
        'grid gap-y-3 lg:gap-x-8 ' +
        'lg:[grid-template-columns:120px_minmax(0,1fr)]'
      }
    >
      {/* Thumbnails rail (có padding phải để “thở”) */}
